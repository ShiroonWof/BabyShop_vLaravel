            ...
            <div class="row">
                ...
                <div class="col-sm-9">
                    <div class="beta-products-list">
                        <h4><b>Tất cả sản phẩm {{$ten_loai_sp->name}}: </b></h4>
                            ...
                            <div class="col-sm-4">
                                <div class="single-item">
                                    ...
                                    <div class="single-item-header">
                                        <a href="{{route("chi-tiet-san-pham",$sp->id)}}"><img src="BabyShop_Interface/image/product/{{$sp->image}}" alt="" height="240px"></a>
                                    </div>
                                    ...
                                    <div class="single-item-caption">
                                        <a class="add-to-cart pull-left" href="{{route('them-vao-gio-hang',$sp->id)}}"><i class="fa fa-shopping-cart"></i></a>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4">
                                <div class="single-item">
                                    ...
                                    @endif
                                    <div class="single-item-header">
                                        <a href="product.html"><img src="BabyShop_Interface/image/product/{{$spk->image}}" alt="" height="240px"></a>
                                    </div>
                                    <div class="single-item-body">
                                    ...
                                    <div class="single-item-caption">
                                        <a class="add-to-cart pull-left" href="{{route('them-vao-gio-hang',$spk->id)}}"><i class="fa fa-shopping-cart"></i></a>
                                        <a class="beta-btn primary" href="product.html">Details <i class="fa fa-chevron-right"></i></a>
                                        <div class="clearfix"></div>
                                    </div>
                                </div>
